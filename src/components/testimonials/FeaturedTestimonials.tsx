      ...
      <div className='flex h-screen justify-center lg:items-center'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          <div className='bg-moderate-violet text-white md:col-span-2 rounded-lg shadow-lg'>
            <div className={`bg-no-repeat bg-[length:100px_100px] bg-[top_right_2rem] md:bg-[length:145px_145px] md:bg-[top_right_5rem] bg-[url('src/assets/images/bg-pattern-quotation.svg')]`}>
